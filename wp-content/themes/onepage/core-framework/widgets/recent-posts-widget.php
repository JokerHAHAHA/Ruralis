...
function __construct() {
    parent::__construct(
        ...
        esc_html__('IG Recent Posts', 'onepage'), // Name
        array('description' => esc_html__('An extended version of the recent posts widget.', 'onepage' ),) // Args
    );
}
...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'post' ); ?>"><?php esc_html_e( 'Post type:' , 'onepage' ); ?></label>
       <span style="color:#888; display:block;"><?php esc_html_e( 'Display a custom post type - only premium' , 'onepage' ); ?></span>
    </p>
    <p>
        <label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts to show:' , 'onepage' ); ?></label>
    ...
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'date' ); ?>"><?php esc_html_e( 'Display post date?', 'onepage' ); ?></label>
    </p>
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'img' ); ?>"><?php esc_html_e( 'Display post image?', 'onepage' ); ?></label>
    </p>
    <p>
        ...
        <label for="<?php echo $this->get_field_id( 'excerpt' ); ?>"><?php esc_html_e( 'Display post excerpt?', 'onepage' ); ?></label>
    </p>
<?php
}
