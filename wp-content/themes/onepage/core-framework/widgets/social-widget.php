...
function __construct() {
    parent::__construct(
        ...
        esc_html__('IG Social', 'onepage'), // Name
        array('description' => esc_html__('Show your social profiles pages.', 'onepage' ),) // Args
    );
}
...
?>
    ...
    <?php if ( ! empty( $instance['title'] ) ) {
        ...
        <?php if ( ! empty( $instance['facebook'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Facebook", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['twitter'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Twitter", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['google'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Google Plus", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['pinterest'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Pinterest", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['tumblr'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Tumblr", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['instagram'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Instagram", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['linkedin'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Linkedin", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['dribbble'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Dribbble", "onepage") ."</span></a>";
        }?>
        <?php if ( ! empty( $instance['vimeo'] ) ) {
              ...
              echo "<span class='text'>". esc_html__("Vimeo", "onepage") ."</span></a>";
        }?>
...
?>
    <p>
        <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title:' , 'onepage' ); ?></label>
        <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" />
    </p>
    <p>
        <label for="<?php echo $this->get_field_id( 'facebook' ); ?>"><?php esc_html_e( 'Facebook url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'twitter' ); ?>"><?php esc_html_e( 'Twitter url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'google' ); ?>"><?php esc_html_e( 'Google url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'pinterest' ); ?>"><?php esc_html_e( 'Pinterest url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'tumblr' ); ?>"><?php esc_html_e( 'Tumblr url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'instagram' ); ?>"><?php esc_html_e( 'Instagram url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'linkedin' ); ?>"><?php esc_html_e( 'Linkedin url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'dribbble' ); ?>"><?php esc_html_e( 'Dribbble url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'vimeo' ); ?>"><?php esc_html_e( 'Vimeo url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'youtube' ); ?>"><?php esc_html_e( 'Youtube url:' , 'onepage' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'rss' ); ?>"><?php esc_html_e( 'RSS url:' , 'onepage' ); ?></label>
