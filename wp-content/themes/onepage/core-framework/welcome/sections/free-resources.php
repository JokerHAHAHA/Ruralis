...
<h2><?php esc_html_e( 'Free resources', 'onepage' ); ?></h2>
    <p><?php esc_html_e( 'Take a look to our free resources of themes and plugins.', 'onepage' ); ?></p>
<div class="ig-themes">
    <div class="ig-col ig-col2">
        <div class="ig-boxed ig-row">
        <h3><span class="dashicons dashicons-admin-appearance"></span> <?php esc_html_e( 'Free themes', 'onepage' ); ?></h3>
            <?php
            ...
            if ( !is_wp_error($response) ) {
                ...
                echo esc_html__('An error has occurred', 'onepage');
            }
            else {
            ...
            if ( $theme ) {
                ...
                <div class="item-details">
                    ...
                    <span class="item-status"><?php esc_html_e( 'installed', 'onepage' ); ?></span>
                    <?php }	else {
                    ...
                    <a class="install" href="<?php echo esc_url( wp_nonce_url( $install_url, 'install-theme_' . $theme->slug ) ); ?>" >
                        <?php esc_html_e( 'Install Now', 'onepage' ); ?>
                    </a>
                    <?php } ?>
                    </span><!-- item-buttons -->
                </div><!-- item-details -->
...
<div class="ig-plugins">
    <div class="ig-col ig-col2">
        <div class="ig-boxed ig-row">
    <h3><span class="dashicons dashicons-admin-plugins"></span> <?php esc_html_e( 'Free plugins', 'onepage' ); ?></h3>
    <?php
    $args = array(
        'author' => 'iografica',
        'fields' => array(
    ...
    if ( !is_wp_error($response) ) {
        ...
        <div class="item-details">
            ...
            <div class="item-description">
                <?php echo esc_html(substr($plugin->short_description, 0, 60). __( '&#8230;', 'onepage' ));?>
            </div><!-- item-description -->
            <span class="item-buttons">
                <a class="download" target="_blank" href="<?php echo esc_url($plugin->download_link); ?>">
                    <?php esc_html_e( 'Download Now', 'onepage' ); ?>
                </a>
            </span><!-- item-buttons -->
        </div><!-- item-details -->
        </div><!-- item -->
