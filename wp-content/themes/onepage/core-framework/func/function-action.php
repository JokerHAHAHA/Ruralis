        ...
        <div class="grid">
            <div class="row">
                ...
                <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
                    <span class="icon_menu-square_alt2"></span> <?php esc_html_e( 'Menu', 'onepage' ); ?>
                </button>
                <?php if (is_home() || is_front_page()) {
                            wp_nav_menu( array( 'theme_location' => 'homepage-menu', 'menu_class' => 'nav-menu' ) );
...
function igthemes_footer_gotop() { ?>
                    <div class="gotop">
                        <a href="#masthead" id="smoothup"  title="<?php esc_attr_e('Back to top', 'onepage' ); ?>">
...
function igthemes_footer_credits() { ?>
    ...
    <div class="credits">
        <div class="grid">
            <div class="row">
                <div class="col12">
                        <?php printf( esc_html__( 'Proudly powered by ', 'onepage' )); ?><a href="<?php echo esc_url( __( 'http://wordpress.org/', 'onepage' ) ); ?>"><?php printf( __( '%s', 'onepage' ), 'WordPress' ); ?></a>
                        <span class="sep"> | </span>
                        <?php printf( esc_html__( 'Theme: %1$s by %2$s.', 'onepage' ), 'Onepage', '<a href="http://iograficathemes.com/" rel="designer">Iografica Themes</a>' ); ?>
                </div><!-- .col12 -->
            </div><!-- .row -->
        </div><!-- .grid -->
    </div><!-- .credits -->
