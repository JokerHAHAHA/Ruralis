...
function igthemes_font_url() {
     ...
     */
    if ( 'off' !== _x( 'on', 'Open Sans font: on or off', 'onepage' )) {
        $fonts[] = 'Open Sans:300italic,400italic,700italic,300,400,700';
    }
    /*
     * Translators: To add an additional character subset specific to your language,
     * translate this to 'greek', 'cyrillic' or 'devanagari'. Do not translate into your own language.
     */
    $subset = _x( 'no-subset', 'Add new subset (greek, cyrillic, vietnamese)', 'onepage'  );
...
//carousel css
if (igthemes_option('shop_slide') || igthemes_option('post_slide') || igthemes_option('portfolio_section') || igthemes_option('testimonials_section') ) {
...
//main js
    wp_enqueue_script( 'igthemes-main', get_template_directory_uri() . '/js/main.min.js', array('jquery'), '1.0', true );
//comment js
